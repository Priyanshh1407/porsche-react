          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className={`${theme.footerText} text-sm lg:text-base leading-relaxed max-w-md`}>
                Experience the ultimate track-focused sports car. The <span className={`${theme.footerHeading} font-medium`}>911 GT3 RS</span> delivers uncompromising performance with racing-inspired technology and aerodynamics.
              </p>
            </div>
        ...
        <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-slate-700/50">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className={`${theme.footerText} text-xs lg:text-sm`}>
              © 2024 <span className={`${theme.footerHeading} font-medium`}>Porsche GT3 RS</span>. All rights reserved.
            </p>
