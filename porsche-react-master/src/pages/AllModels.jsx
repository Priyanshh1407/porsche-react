      ...
      <div className="relative z-10">
        ...
        <header className="p-6 border-b border-gray-800/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className={`flex items-center justify-between mb-6 animate-float-up ${animateElements ? 'animate' : ''}`}>
            ...
            {/* Category Filter */}
            <div className={`flex flex-wrap gap-2 animate-float-up-delay-1 ${animateElements ? 'animate' : ''}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 transition-all duration-500 ${isAnimating ? 'opacity-0 transform translate-x-8' : 'opacity-100 transform translate-x-0'}`}>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className={`bg-gray-900/50 border border-gray-800 rounded-xl p-6 backdrop-blur-sm hover:border-gray-700 transition-colors animate-card-stagger ${animateElements ? 'animate' : ''}`}>
              ...
              {/* Features */}
              <div className={`animate-float-up-delay-2 ${animateElements ? 'animate' : ''}`}>
              ...
              {/* CTA & Explore Button */}
              <div className={`flex justify-start gap-4 animate-float-up-delay-3 ${animateElements ? 'animate' : ''}`}>
            ...
            <div className={`space-y-6 animate-float-up-delay-1 ${animateElements ? 'animate' : ''}`}>
              ...
              <div ref={scrollRef} className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                {filteredModels.map((model, index) => (
                  <div
                    ...
                    className={`cursor-pointer p-6 rounded-xl border-2 transition-all duration-300 transform hover:scale-[1.02] animate-card-stagger ${animateElements ? 'animate' : ''} ${index === activeModel
