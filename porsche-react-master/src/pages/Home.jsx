        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
                ...
                <div className="absolute inset-0 flex items-center">
                    <div className="max-w-7xl mx-auto px-8 w-full">
                        <div className="max-w-2xl">
                            <div className={`mb-4 animate-float-up ${animateElements ? 'animate' : ''}`}>
                                <span className="text-red-500 text-sm font-medium tracking-wider uppercase">
                                    {heroSlides[activeHero].subtitle}
                                </span>
                            </div>
                            <h1 className={`text-7xl font-light mb-6 animate-float-up-delay-1 ${animateElements ? 'animate' : ''}`}>
                                {heroSlides[activeHero].title}
                            </h1>
                            <p className={`text-xl text-gray-300 mb-8 animate-float-up-delay-2 ${animateElements ? 'animate' : ''}`}>
                                {heroSlides[activeHero].description}
                            </p>
                            <div className={`flex gap-4 animate-float-up-delay-3 ${animateElements ? 'animate' : ''}`}>
            ...
            <section className="py-24 bg-gradient-to-b from-black to-gray-900">
                <div className="max-w-7xl mx-auto px-8">
                    <div className={`text-center mb-16 animate-float-up ${animateElements ? 'animate' : ''}`}>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {models.map((model, index) => (
                            <div 
                                key={model.name} 
                                className={`relative animate-card-stagger ${animateElements ? 'animate' : ''}`}
                            ...
                            >
                                ...
                                {activeDropdown === index && modelVariants[model.name] && (
                                    <div className="w-full relative mt-2 bg-gray-800/95 backdrop-blur-sm rounded-lg border border-gray-700/50 shadow-2xl animate-slide-down">
                                        <div className="p-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {motorsportAchievements.map((achievement, index) => (
                            <div
                                ...
                                style={{ animationDelay: `${index * 0.2}s` }}
                            >
                                <div className="h-full flex flex-col bg-black/50 rounded-lg p-6 transition-all duration-300 hover:bg-black/70 border border-gray-700/50 hover:border-red-500/50 backdrop-blur-sm">
                                    <div className="text-red-500 text-2xl font-light mb-3 group-hover:scale-110 transition-transform origin-left">
                                        {achievement.year}
                                    </div>
               ...
               backdrop-blur-sm hover:backdrop-blur-md flex items-center gap-3 mx-auto"
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isLegacyOpen ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                                    ...
                                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        {milestones.map((milestone, index) => (
                                            <div key={milestone.year} className="relative group h-full">
                                                <div className="h-full flex flex-col bg-gradient-to-br from-red-600/10 to-red-500/5 rounded-lg p-4 
                            ...
                            hover:bg-gradient-to-br hover:from-red-600/20 hover:to-red-500/10">
                                                    ...
                                                    <p className="text-gray-400 text-xs flex-grow">{milestone.description}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        {legacyDetails.map((category, index) => {
                                            ...
                                            return (
                                                <div key={category.category} className="group h-full">
                                                    <div className="h-full flex flex-col bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-lg p-5 
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className={`space-y-8 animate-float-up ${animateElements ? 'animate' : ''}`}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className={`flex items-center gap-4 animate-float-up-delay-4 ${animateElements ? 'animate' : ''}`}>
                                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                                    <span className="text-gray-300">Comprehensive warranty and service</span>
                                </div>
                            </div>
                            <div className={`flex gap-4 pt-4 animate-float-up-delay-5 ${animateElements ? 'animate' : ''}`}>
                                <button 
